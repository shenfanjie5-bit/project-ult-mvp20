...
汽车零部件、工程机械、通用机械、工业设备、家电、工具、轻工消费品，以及海外收入占比较高的中国制造企业。

**核心判断：**该板块的核心是海外需求、渠道库存、本地化产能、汇率、关税和品牌/产品升级。出海不是简单出口增长，而是利润率、现金流和政策风险的组合。
...
```mermaid
flowchart LR
  E1["海外需求/补库存/汇率"] --> S1["出口订单与海外份额"]
  E2["本地化产能/关税/品牌渠道"] --> S2["ASP、毛利率与渠道库存"]
  S1 --> F1["收入增长与利润率"]
  S2 --> F2["现金流与汇兑损益"]
  F1 --> V1["全球化制造估值重估"]
  F2 --> V1
  V1 --> A["公司超额收益 alpha"]
  R1["贸易摩擦/需求下滑/库存风险"] -. 折扣/尾部风险 .-> V1
  R1 -. 证伪 .-> A
```
...
|---|---|---|---|---:|---:|---|---|---|
| 海外需求路径 | 海外需求修复/补库存 → 出口订单增长 → 收入上修 | 出口数据、订单、渠道库存 | 海外需求放缓、去库存延续 | 0.70 | 0.70 | 中：订单持续性比单月数据重要 | 1-4个季度 | 需求组 |
| 本地化路径 | 海外建厂/本地供应 → 关税影响下降 → 客户粘性提升 | 海外产能、客户认证、当地订单 | 建厂成本高、利用率不足 | 0.65 | 0.55 | 中：产能利用率需达临界点 | 3-8个季度 | 竞争组 |
| 汇率路径 | 人民币贬值或汇兑有利 → 出口收入和毛利改善 | 汇率、套保比例、海外收入占比 | 汇率反向、套保损失 | 0.55 | 0.60 | 中：需看套保和结算币种 | 即时-2个季度 | 价格组 |
| 产品升级路径 | 高端产品/品牌渠道提升 → ASP上升 → 毛利率改善 | 产品结构、海外品牌、渠道份额 | 低价竞争、品牌力不足 | 0.75 | 0.65 | 中高：高毛利产品占比提升 | 2-6个季度 | 质量组 |
| 汽车零部件路径 | 全球车企定点 → 平台生命周期订单 → 收入可见度提升 | 定点公告、SOP时间、车型销量 | 车型销量不及预期、降价压力 | 0.75 | 0.70 | 中高：定点金额和SOP节奏关键 | 3-10个季度 | 需求组 |
| 贸易风险路径 | 关税/制裁/贸易摩擦 → 成本上升或订单转移 → 估值压缩 | 关税政策、客户转单、合规成本 | 本地化和供应链调整成功 | 0.50 | 1.15 | 中高：海外占比高时更敏感 | 即时-4个季度 | 风险组 |
...
| 财务向量 | 影响逻辑 |
|---|---|
| Revenue | 海外订单、SOP、渠道补库存驱动 |
| GrossMargin | 产品结构、汇率、关税和运费影响 |
| OpexRatio | 海外渠道和本地化建设费用 |
| EBIT/EPS | 规模和高端产品占比提升带来弹性 |
| FCF | 海外扩产和应收账款影响 |
| Leverage | 本地化重资产投入需看负债 |
...
| PB | 10% | 银行、保险、资源、周期底部或资产重估场景。 |
| SOTP | 10% | 业务结构复杂或多管线、多环节公司。 |
...
**出海制造汽车零部件机械家电的图谱重点不是判断“这个行业好不好”，而是判断：利好是否超预期、是否已经反映、能否传导到公司财务、估值是否还有空间、尾部风险是否足以吞掉收益。**
