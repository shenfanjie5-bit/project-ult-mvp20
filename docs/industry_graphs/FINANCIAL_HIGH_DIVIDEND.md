...
券商、保险、银行、多元金融、交易所产业链、金融科技，以及高股息央国企和红利资产。

**核心判断：**该板块的核心变量是资本市场成交和风险偏好、利率曲线、资产质量、权益市场表现、分红回购和政策呵护。金融股对大盘和行业贝塔尤其敏感，必须先剥离市场影响。
...
```mermaid
flowchart LR
  E1["资本市场政策/成交放大"] --> S1["券商业绩与保险投资收益"]
  E2["利率曲线/经济修复/分红回购"] --> S2["银行息差与资产质量"]
  S1 --> F1["手续费、投资收益、信用成本"]
  S2 --> F2["ROE与分红能力"]
  F1 --> V1["PB修复/高股息估值"]
  F2 --> V1
  V1 --> A["公司超额收益 alpha"]
  R1["信用风险/息差收窄/市场回落"] -. 折扣/尾部风险 .-> V1
  R1 -. 证伪 .-> A
```
...
|---|---|---|---|---:|---:|---|---|---|
| 券商弹性路径 | 市场成交放大 → 经纪/两融/自营改善 → 券商业绩上修 | 成交额、两融余额、IPO再融资 | 成交萎缩、权益市场回落 | 0.80 | 0.85 | 中：日均成交需持续 | 即时-2个季度 | 资金组 |
| 保险路径 | 权益市场上涨/长端利率改善 → 投资收益和内含价值改善 → 估值修复 | 权益指数、长端利率、保费/NBV | 股市回落、利率下行 | 0.70 | 0.75 | 中：投资收益和负债端需同步 | 1-4个季度 | 估值组 |
| 银行路径 | 经济修复/信用风险缓和 → 不良压力下降 → PB修复 | 不良率、拨备、社融、净息差 | 资产质量恶化、息差收窄 | 0.60 | 0.70 | 中：资产质量比收入弹性更关键 | 2-6个季度 | 信用组 |
| 红利路径 | 分红回购提升 → 股息率吸引力增强 → 长线资金配置 | 分红率、回购、现金流、央国企改革 | 盈利下行导致分红不可持续 | 0.65 | 0.55 | 中：分红需要现金流支撑 | 1-4个季度 | 资金组 |
| 政策信心路径 | 资本市场稳定政策 → 风险偏好回升 → 金融板块估值修复 | 政策信号、市场成交、基金发行 | 政策低于预期或外部冲击 | 0.65 | 0.70 | 中：需市场反馈确认 | 即时-2个季度 | 政策组 |
| 信用尾部路径 | 地产/地方债/企业信用风险 → 银行资产质量恶化 → 金融估值压缩 | 不良率、信用利差、违约事件 | 风险化解和拨备充足 | 0.50 | 1.20 | 中高：低估值也可能有价值陷阱 | 即时-6个季度 | 风险组 |
...
| 财务向量 | 影响逻辑 |
|---|---|
| Revenue | 手续费、利息收入、保费和投资收益 |
| GrossMargin/Spread | 银行看净息差，保险看投资收益和负债成本 |
| OpexRatio | 金融机构成本收入比 |
| EBIT/EPS | 市场行情对券商和保险弹性大 |
| FCF | 分红和资本补充能力 |
| ROE | 银行保险券商估值核心指标 |
...
| 估值模型 | 建议初始权重 | 使用场景 |
|---|---:|---|
| PB | 40% | 银行、保险、资源、周期底部或资产重估场景。 |
| PE | 25% | 盈利稳定或进入利润兑现阶段。 |
| 股息模型 | 20% | 红利、高股息和现金流稳定资产。 |
| ROE-PB模型 | 10% | 银行保险等金融资产。 |
| SOTP | 5% | 业务结构复杂或多管线、多环节公司。 |
...
**金融券商保险银行高股息的图谱重点不是判断“这个行业好不好”，而是判断：利好是否超预期、是否已经反映、能否传导到公司财务、估值是否还有空间、尾部风险是否足以吞掉收益。**
