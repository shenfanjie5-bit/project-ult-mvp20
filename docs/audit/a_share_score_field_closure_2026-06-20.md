...
- Score-relevant closed fields: `132` / `174`
- Blocking gaps: `21`
- Candidate-ready blockers: `21`
...
| Status | Count |
|---|---:|
| `closed_reaches_final_score` | 132 |
| `no_valid_a_share_target_data` | 7 |
| `non_scoring_spec` | 82 |
| `overlay_only_no_score_candidate` | 17 |
...
- Existing Tushare/AKShare rows currently support candidate generation for 21 blockers, but direct structured Tushare gaps are already exhausted.
