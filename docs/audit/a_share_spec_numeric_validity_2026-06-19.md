...
- Current numeric final-score fields: `121` / `174` (`69.54%`)
- Score-relevant fields not currently in final score: `53`
- Actionable blocking gaps: `32`
...
| `overlay_information_not_score_candidate` | 28 |
