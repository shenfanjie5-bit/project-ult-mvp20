...
- Generated: `2026-06-20T00:26:54+08:00`
...
- Grain-join policy required: `1`
- Text full-match export required: `3`
- Market/event scope policy required: `14`
- Unsupported materialization policy: `0`
- Runtime materialization plans ready: `7`
...
| `structured_formula_grain_join_review_required` | 1 |
| `text_evidence_subset_requires_full_match_export` | 3 |
...
| `L0.demand.user_count` | `text_evidence_subset_requires_full_match_export` | `export_full_text_match_target_scope` | 0 | text examples=4 |
...
| `L0.price.contract_spot` | `structured_formula_grain_join_review_required` | `approve_grain_join_materialization_policy` | 1007 | - |
| `L0.price.discount` | `text_evidence_subset_requires_full_match_export` | `export_full_text_match_target_scope` | 0 | text examples=1 |
...
| `L0.supply.channel_service` | `text_evidence_subset_requires_full_match_export` | `export_full_text_match_target_scope` | 0 | text examples=1 |
