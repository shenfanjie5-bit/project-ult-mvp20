...
- Generated: `2026-06-23T12:17:38+08:00`
...
- Baseline available cells: `711/820`
- Non-LLM candidate available cells: `526/820` (`0.6415`)
- Non-LLM candidate schema-valid cells: `526/526` (`1.0`)
- Score-field non-LLM candidate available cells: `205/270` (`0.7593`)
...
| `status_match_value_differs` | 97 |
| `non_llm_found_baseline_missing` | 85 |
| `non_llm_missing_llm_available` | 29 |
| `both_missing:gated` | 20 |
| `both_missing` | 4 |
| `status_and_value_close` | 1 |
...
| `cheap_extract_rule` | 40 |
| `event_policy_gated` | 31 |
| `existing_deterministic_parser` | 21 |
| `strict_no_llm_now` | 20 |
| `unclassified` | 16 |
| `cheap_extract_formula` | 10 |
| `cheap_extract_parser` | 10 |

## Field Summary

| dp_id | tier | score | baseline avail | non-LLM avail | close | missing vs baseline | top methods |
|---|---|---:|---:|---:|---:|---:|---|
| `L1.moat.tags` | `cheap_extract` | `False` | 10 | 10 | 0 | 0 | rule_tagging:10 |
| `L1.model.tag` | `cheap_extract` | `False` | 10 | 10 | 0 | 0 | rule_tagging:10 |
...
| `L1.position.growth_rank` | `cheap_extract` | `True` | 10 | 10 | 0 | 0 | peer_growth_rank:10 |
...
| `L1.role.tag` | `cheap_extract` | `False` | 10 | 10 | 0 | 0 | rule_tagging:10 |
| `L1.stock_attr.tags` | `cheap_extract` | `False` | 10 | 10 | 0 | 0 | rule_tagging:10 |
...
| `L3.channel.mix` | `cheap_extract` | `True` | 9 | 10 | 0 | 0 | channel_mix_business_proxy:10 |
| `L3.channel.overseas` | `analysis` | `False` | 7 | 9 | 0 | 1 | region_mix_runtime:10 |
| `L3.customer.concentration` | `analysis` | `False` | 9 | 3 | 0 | 6 | no_non_llm_extractor:7, script_fill:3 |
