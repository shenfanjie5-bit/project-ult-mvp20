"""Smoke tests — minimal end-to-end exercise of contracts public entrypoints.

The path ``make smoke`` runs and the path assembly hits during
``stage public_smoke_probes`` of bootstrap.
"""
